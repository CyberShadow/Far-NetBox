  ...
  FGroupTop(0)
{
  ...
  for (intptr_t I = 0; I < SubpluginsManager->GetFSProtocolsCount(); ++I)
  {
    AddProtocolDescription(SubpluginsManager->GetFSProtocolId(I),
      SubpluginsManager->GetFSProtocolStr(I));
  }
...
{
  intptr_t Result = -1;
  for (intptr_t I = 0; I < FTabs->GetCount(); ++I)
  {
...
intptr_t TSessionDialog::GetTabByIndex(intptr_t TabIndex)
{
  intptr_t Result = -1;
  TTabButton * T = NULL;
  if ((TabIndex >= 0) && (TabIndex < FTabs->GetCount()))
  {
